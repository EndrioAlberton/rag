...
public class WhatsAppMessageSenderAdapter implements MessageSenderPort {
    ...
    public boolean sendTypingIndicator(String to, String messageId, String overridePhoneId) {
        ...
        Log.info("WhatsApp feedback enviado para " + to + " — read receipt: "
                + readReceiptSent + ", typing: " + typingSent);
    ...
    /**
     * Sends an hourglass (⏳) reaction to the incoming message as a typing-indicator substitute.
     *
     * @param effectivePhoneId business phone number ID
     * @param to               normalised recipient phone number
